    ...
    <div className="p-2 w-full">
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex gap-1 flex-wrap items-center">
          ...
          <div className="flex items-center gap-1">
            <label className="text-sm text-gray-600 dark:text-gray-300">Evaluator Role</label>
            <select
              value={evaluatorRole}
              ...
              return (
                <React.Fragment key={row._id}>
                  ...
                  >
                    ...
                    <td className="px-2 py-1.5 text-sm text-gray-900 dark:text-gray-100 font-medium">
                      {row.count}
                    </td>
                    <td className="px-2 py-1.5 text-sm text-gray-900 dark:text-gray-100 font-semibold">
                      {row.avgScore}%
                    </td>
                ...
                <div className="overflow-x-auto bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700 rounded-lg shadow w-full">
                  <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                      {ticketLoading && (
                        <tr>
                          <td colSpan={6} className="px-2 py-2 text-center text-sm text-gray-500 dark:text-gray-400">
