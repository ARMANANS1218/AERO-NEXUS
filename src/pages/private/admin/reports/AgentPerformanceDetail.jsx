...
const AgentDetailCard = ({ agent, isDark, tickets }) => {
...
const AgentPerformanceDetail = () => {
  ...
  // Filter only Agents from all employees
  const agents = useMemo(() => {
    const employees = employeesData?.data || [];
    return employees.filter(e => e.role === 'Agent');
  }, [employeesData]);
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-900 dark:to-slate-800 p-2 md:p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Click on any agent to view detailed performance metrics
        </p>
      </div>
