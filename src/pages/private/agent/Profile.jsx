            ...
            <div className="flex-1">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                <div>
                  ...
                  <p className="text-lg font-bold text-gray-900 dark:text-white">{user?.name || 'N/A'}</p>
                </div>
                {['Agent','TL','QA'].includes(user?.role) && (
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Alias Name</p>
                    <p className="text-lg font-bold text-gray-900 dark:text-white">{user?.alias || 'Not Set'}</p>
                  </div>
                )}
                <div>
