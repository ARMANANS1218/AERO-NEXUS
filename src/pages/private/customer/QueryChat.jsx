                ...
                {(() => {
                  ...
                  return (
                    <div className="mt-1 flex items-center gap-2 text-xs text-gray-600 dark:text-gray-300">
                      ...
                      {rel && (
                        <span
                          className="px-2 py-0.5 rounded bg-gray-100 dark:bg-gray-950 text-[10px] text-gray-600 dark:text-gray-300"
                          title={abs}
                        >
                          {rel}
                        </span>
                                  ...
                                  return (
                                    ...
                                    >
                                      <div className="flex items-center gap-1 flex-wrap">
                                        ...
                                        {rel && (
                                          <span
                                            className="px-1 py-0.5 rounded bg-black/10 dark:bg-white/10 text-[10px]"
                                            title={abs}
                                          >
                                            {rel}
                                          </span>
                ...
                >
                  <div className="p-2">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      {snapshotRequest?.requester?.name || "Agent"} is
                      requesting a photo from your camera to verify and assist
                      you better. Do you allow?
                    </p>
                  </div>
